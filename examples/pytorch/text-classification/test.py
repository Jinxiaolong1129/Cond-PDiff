...
def main():
    ...
    model_args.target_modules = ["query", "key", "value", "dense"]
    ...
    # path = "/home/jin509/para_diff/lora-peft-diff/checkpoints/sst2/prolora/debug/checkpoint-27/adapter_model.safetensors"
    # adapter_state_dict = torch.load("checkpoints/sst2/prolora/debug/checkpoint-27/adapter_model.safetensors") 
    # model = PeftModel.from_pretrained(model = model, model_id = "checkpoints/sst2/prolora/debug/checkpoint-27")   
    ...
    # tensors = {}
    # file_path = "checkpoints/sst2/prolora/debug/checkpoint-27/adapter_model.safetensors"
    # with safe_open("checkpoints/sst2/prolora/debug/checkpoint-27/adapter_model.safetensors", framework="pt", device="cpu") as f:
    #     for key in f.keys():
